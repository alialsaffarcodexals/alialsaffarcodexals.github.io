/**
 * login.js
 * Login page behavior: field validation, form submit, and redirect on success.
 */
...
export function initLoginPage() {
  ...
  // Simple input checks for identifier and password fields.
  ...
  // Update classes and message shown under each field.
  ...
  form.addEventListener('submit', async (e) => {
    ...
    // Loading state visuals are handled by CSS class.
