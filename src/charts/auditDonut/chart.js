 ...
 *
 * Originally built for Pass vs Fail.
 * We reuse it for other ratios (e.g. Audits Done vs Received) by passing different values.
 *
 * @param {HTMLElement} container
 * @param {number} passCount - first value (e.g. pass or audits-done XP)
 * @param {number} failCount - second value (e.g. fail or audits-received XP)
 */
export function renderPassFailChart(container, passCount, failCount) {
  ...
  // Make the donut thicker and give the center more room for labels
  const innerR = r * 0.72;
